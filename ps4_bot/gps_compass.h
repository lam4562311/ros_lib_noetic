#ifndef _ROS_ps4_bot_gps_compass_h
#define _ROS_ps4_bot_gps_compass_h
...
namespace ps4_bot
{
  ...
  class gps_compass : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "ps4_bot/gps_compass"; };
